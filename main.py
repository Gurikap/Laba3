...
from DATA import get_postgres, get_path, get_test, get_settings
from manage import to_postgres_and_sqlite
from duckdb import duckdb_q1, duckdb_q2, duckdb_q3, duckdb_q4
from Pandas import pandas_q1, pandas_q2, pandas_q3, pandas_q4
from Postgres import psycopg_q1, psycopg_q2, psycopg_q3, psycopg_q4
from SQLite3 import sqlite_q1, sqlite_q2, sqlite_q3, sqlite_q4
